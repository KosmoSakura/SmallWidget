...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
    ...
    public enum Type {
        ALL, YEAR, YEAR_MONTH_DAY, HOURS_MINS, MONTH_DAY_HOUR_MIN, YEAR_MONTH
...
//        this.setAnimationStyle(R.style.timepopwindow_anim_style);
        ...
        rl_bg = (RelativeLayout) rootView.findViewById(R.id.rl_bg);
        // -----确定和取消按钮
...
//        wheelTime.setPicker(year, month, day, hours, minute);
    ...
    public void onClick(View v) {
        ...
        if (tag.equals(TAG_CANCEL)) {
            ...
            if (timeSelectListener != null) {
                ...
                timeSelectListener.onDate(wheelTime.getYear(), wheelTime.getMonth(), wheelTime.getDay(), wheelTime.getHour(), wheelTime.getMin(), wheelTime.getHours());
            }
            dismiss();
            return;
        }
    ...
    public static abstract class OnTimeSelectListener {
        public abstract void onTimeSelect(String date);
