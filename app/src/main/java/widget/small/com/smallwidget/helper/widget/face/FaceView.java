package widget.small.com.smallwidget.helper.widget.face;
...
import widget.small.com.smallwidget.helper.widget.face.camera.CameraInterface;
import widget.small.com.smallwidget.helper.widget.face.util.Util;
...
public class FaceView extends android.support.v7.widget.AppCompatImageView {
	...
	public FaceView(Context context, AttributeSet attrs) {
		...
		initPaint();
		mContext = context;
		mFaceIndicator = getResources().getDrawable(R.drawable.ic_face_g);
	}
