package widget.small.com.smallwidget.helper.widget.material;
...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        if (isSunStyle) {
            ...
            mSunLayout = new CustomerLayout(context);
            LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Util.dip2px(context, hIGHER_HEAD_HEIGHT));
            layoutParams.gravity = Gravity.TOP;
            mSunLayout.setWaveColor(isShowWave ? waveColor : Color.TRANSPARENT);
            mSunLayout.setVisibility(View.GONE);
            //customerLayout.setLayoutParams(layoutParams);
            setHeaderView(mSunLayout);
        } else {
