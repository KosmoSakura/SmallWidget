...
public class SnackbarUtils {
    ...
    public static void kosmosSnackbar(View parent, CharSequence text) {
        showShortSnackbar(parent, text, Color.parseColor("#ffffff"), Color.parseColor("#333333"));
    }
    ...
    public static void showShortSnackbar(View parent, CharSequence text, @ColorInt int textColor, @ColorInt int bgColor) {
        kosmosSnackbar(parent, text, Snackbar.LENGTH_SHORT, textColor, bgColor, null, -1, null);
    }
    ...
    public static void showShortSnackbar(View parent, CharSequence text, @ColorInt int textColor, @ColorInt int bgColor,
        ...
        kosmosSnackbar(parent, text, Snackbar.LENGTH_SHORT, textColor, bgColor,
    ...
    public static void showLongSnackbar(View parent, CharSequence text, @ColorInt int textColor, @ColorInt int bgColor) {
        kosmosSnackbar(parent, text, Snackbar.LENGTH_LONG, textColor, bgColor, null, -1, null);
    }
    ...
    public static void showLongSnackbar(View parent, CharSequence text, @ColorInt int textColor, @ColorInt int bgColor,
                                        CharSequence actionText, int actionTextColor, View.OnClickListener listener) {
        kosmosSnackbar(parent, text, Snackbar.LENGTH_LONG, textColor, bgColor,
            actionText, actionTextColor, listener);
    }
    ...
    public static void showIndefiniteSnackbar(View parent, CharSequence text, @ColorInt int textColor, @ColorInt int bgColor) {
        kosmosSnackbar(parent, text, Snackbar.LENGTH_INDEFINITE, textColor, bgColor, null, -1, null);
    }
    ...
    public static void showIndefiniteSnackbar(View parent, CharSequence text, @ColorInt int textColor, @ColorInt int bgColor,
                                              CharSequence actionText, int actionTextColor, View.OnClickListener listener) {
        kosmosSnackbar(parent, text, Snackbar.LENGTH_INDEFINITE, textColor, bgColor,
            actionText, actionTextColor, listener);
    }
     ...
     * @param listener        监听器
     */
    private static void kosmosSnackbar(View parent, CharSequence text,
                                       int duration,
