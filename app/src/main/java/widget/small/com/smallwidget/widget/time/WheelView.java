...
package widget.small.com.smallwidget.widget.time;
...
public class WheelView extends View {
     ...
     */
    private static final int VALUE_TEXT_COLOR = 0xFF333333;//选中的字体颜色
//    private static final int VALUE_TEXT_COLOR = 0xFF666666;

    /**
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0xFF666666;//未选中的字体颜色
     ...
     */
    private static final int ADDITIONAL_ITEM_HEIGHT = 40;//每个项目的高度

    /**
     * Text size
     */
    public int TEXT_SIZE;//字体大小
     ...
     * Label offset ,   dip
     */
    private static int LABEL_OFFSET_DIP =80;
    /**
     * Label offset
     */
    ...
    private void initResourcesIfNecessary() {
        TEXT_SIZE = (int) (getContext().getResources().getDisplayMetrics().density * 20F);
        if (itemsPaint == null) {
            itemsPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
            // itemsPaint.density = getResources().getDisplayMetrics().density;
            itemsPaint.setTextSize(TEXT_SIZE);
            itemsPaint.setColor(0xFF00FF00);
        }
...
//			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
        ...
        if (centerDrawable == null) {
            ...
            centerDrawable = getContext().getResources().getDrawable(R.drawable.bg_line_timepicker);
        }
