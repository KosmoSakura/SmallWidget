package widget.small.com.smallwidget.helper.widget.switchlayout;
...
public abstract class SwitchLayout {
    ...
    public static void getSlideFromTop(Activity context, boolean isCloseActivity, Interpolator interpolator) {
        activity = context;
    ...
    public static void getSlideToTop(final Activity context, boolean isCloseActivity, Interpolator interpolator) {
        activity = context;
