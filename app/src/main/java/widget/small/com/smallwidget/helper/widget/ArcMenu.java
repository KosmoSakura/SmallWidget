package widget.small.com.smallwidget.helper.widget;
...
public class ArcMenu extends ViewGroup implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        // mCButton = getChildAt(0);
        // }
//        if (mArcMenuClickListener != null) {
//            if (mCurrentStatus == Status.OPEN) {
//                mArcMenuClickListener.onClick(true);
//            } else {
//                mArcMenuClickListener.onClick(false);
//            }
//        }
//        rotateCButton(v, 0f, 360f, 300);
    ...
    public boolean closed(int duration) {
        if (isOpen()) {
            toggleMenu(duration);
            return false;
        } else return true;
            ...
            tranAnim.setAnimationListener(new AnimationListener() {
                ...
                public void onAnimationStart(Animation animation) {
                    ...
                    if (mMenuItemClickListener != null) {
                        if (mCurrentStatus == Status.OPEN) {
                            mMenuItemClickListener.opening(true);
                        } else {
                            mMenuItemClickListener.opening(false);
                        }
                    }
                }
